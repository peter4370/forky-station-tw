...
chat-manager-dead-looc-chat-enabled-message = Dead players can now use Help Chat.
chat-manager-dead-looc-chat-disabled-message = Dead players can no longer use Help Chat.
chat-manager-crit-looc-chat-enabled-message = Crit players can now use Help Chat.
chat-manager-crit-looc-chat-disabled-message = Crit players can no longer use Help Chat.
