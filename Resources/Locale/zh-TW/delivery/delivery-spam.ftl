...
delivery-spam-5 =   FREE ALL AXCESS!!
    ...
    .content =      [head=3]Have You ever wanted to have [italic][color=green]Free [bold]All Axcess!?!?[/bold][/color][/italic][/head] { "[head=2]Well NOW YOU CAN!![/head]!" }
...
delivery-spam-9 =   Do you want to fight?!
    ...
    .content =      [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color] { "[bold][head=1]THE RAGE CAGE[/head][/bold]" }
                                                { "[color=#aaaaaa]▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[/color]" }
