...
ent-WeaponDisablerPractice = practice blaster
    .desc = A prop blaster, designed specifically to emulate firing a real energy weapon.
...
ent-WeaponEnergyShotgun = energy shotgun
    .desc = A one-of-a-kind prototype energy weapon that uses two different shotgun configurations. It offers the possibility of both focused and wide shots, making it a versatile weapon.
ent-WeaponEnergyMagnum = energy magnum
    .desc = A high powered self-charging energy pistol designed for elite security personnel. It has has two firing modes, allowing for either high damage or window piercing.
