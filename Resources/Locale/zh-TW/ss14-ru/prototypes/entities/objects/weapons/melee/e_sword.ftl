...
ent-CyborgEnergySword = { ent-EnergySword }
    .desc = A very loud & dangerous sword with a beam made of pure, concentrated plasma. Specially designed for syndicate automas.
    .suffix = For Automas
ent-CyborgEnergySwordDouble = { ent-EnergySwordDouble }
    .desc = Syndicate Command Interns thought that having one blade on the energy sword was not enough. Specially designed for syndicate automas.
    .suffix = One-Handed, For Automas
