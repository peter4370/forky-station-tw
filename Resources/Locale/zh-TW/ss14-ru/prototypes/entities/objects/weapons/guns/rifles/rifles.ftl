...
ent-WeaponRifleEstoc = Estoc DMR
    .desc = A designated marksman rifle firing in 2-round bursts. The Estoc was designed as a long-range marksman rifle, equipped with an extended 20-inch barrel and telescopic sight.Feeds from .50 rifle magazines.
